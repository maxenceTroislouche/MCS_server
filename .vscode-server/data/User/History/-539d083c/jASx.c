...
void dialogueClt(int sd, struct sockaddr_in clt)
{
    ...
    char username[100] = strtok(buffer, ":");
    char password[100] = strtok(NULL, ":");
    char reste[100] = strtok(NULL, ":");
    ...
    printf("Bon format !\n");
    char *authentification_string;
    strcpy(authentification_string, username);
    strcat(authentification_string, ":");
    strcat(authentification_string, password);
